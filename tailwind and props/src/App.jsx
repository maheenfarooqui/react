...
function App() {
  ...
  return (
    <>
    <h1 className="bg-amber-400 p-12 rounded-3xl m-12 font-bold flex justify-center">Taiwind Test</h1>
...
{/* its from dev ui */}
<Card name= "harry" dec="hello i am here to help you" btnText = "read more" />
